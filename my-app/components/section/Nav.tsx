...
<>
   ...
   className="lg:justify-start lg:flex-wrap px-3 justify-between items-center relative flex flex-no-wrap bg-white border-gray-200 dark:bg-gray-900 bg-zinc-50 py-2 shadow-dark-mild dark:bg-neutral-700">
