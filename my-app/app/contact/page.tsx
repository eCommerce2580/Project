      ...
      <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            <div>
              <span className="inline-block p-3 text-gray-900 rounded-full bg-gradient-to-r from-orange-200 via-purple-200 to-blue-200 hover:from-orange-300 hover:via-purple-300 hover:to-blue-200 dark:bg-gray-800">
              ...
              <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">ecommerce2580@gmail.com</p>
            </div>
